...
function MainComponent() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessages = {
        CredentialsSignin: "Hatalı e-posta veya şifre. Lütfen tekrar deneyin.",
        Configuration:
          "Giriş sistemi şu an kullanılamıyor. Lütfen tekrar deneyin.",
        AccessDenied: "Bu hesaba erişim izniniz bulunmuyor.",
